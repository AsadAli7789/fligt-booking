...
<div className={bord=="first"?"bord py-5":"trans  py-5"} onClick={()=>{bord=="first"?setbord(""):setbord("first")}} >
...
<div className={bord=="second"?"bord  py-5":"trans  py-5"} onClick={()=>{bord=="second"?setbord(""):setbord("second")}} >
<div className=" h-full  pr-10 ">
    <h1>Best</h1>
    <span>$99</span><span>2h 18m</span>
</div>
...
<div className={bord=="third"?"bord  py-5":"trans py-5"} onClick={()=>{bord=="third"?setbord(""):setbord("third")}}>
<div className=" h-full  pr-10 ">
    <h1>Quickest</h1>
    <span>$99</span><span>2h 18m</span>
</div>
...
<div  className={bord=="fourth"?"bord  py-5":"trans  py-5"} onClick={()=>{bord=="fourth"?setbord(""):setbord("fourth")}}>
